...
TypeaheadWrapper.prototype.createBloodhoundDataset = function (source, queryUrl, queryInfoName) {

    let bloodHoundParams = {};
    ...
    return new Bloodhound(bloodHoundParams);
};
