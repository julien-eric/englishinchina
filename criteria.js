...
module.exports = {
  criteria: [
    ...
    {
      code: 1,
      label: 'cri_supportOnArrivalandVisa',
      shortName: 'Support',
    ...
    {
      code: 2,
      label: 'cri_managementAdministration',
    ...
    {
      code: 5,
      label: 'cri_locationAccesibility',
      shortName: 'Location',
